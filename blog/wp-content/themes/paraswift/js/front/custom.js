...
$(document).ready(function(){
	$('.mrg_btm span.carimg_br12').on('click', function(event){
   ...
   $(window).scroll(function () {
      ...
      var distance = $('#menu-area').offset().top,
	    $window = $(window);

	  $window.scroll(function() {
	      if ( $window.scrollTop() >= distance ) {
	        $('#menu-area').addClass('stickey');
	      }else{
	        $('#menu-area').removeClass('stickey');
	      }
	  });
		...
		$('#payindividual').on('click',function(){
			debugger;
		});
